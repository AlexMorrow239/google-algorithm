...
/**
 * An implementation of SearchDisplay.UserInterface using popup windows and buttons.
 *
 * @author vjm
 */
public class GUI implements UserInterface {
    ...
    /**
     * Creates a new instance of SearchDisplay.GUI
     *
    ...
    public static void main(String[] args) {
        UserInterface ui = new GUI("Test SearchDisplay.GUI");
